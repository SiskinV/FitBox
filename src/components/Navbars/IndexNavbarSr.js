                    ...
                    >
                        <Nav navbar>
                            ...
                            <UncontrolledDropdown nav>
                                ...
                                <DropdownMenu>
                                    <DropdownItem to="/training-pageSr" tag={Link}>
                                        <i className="now-ui-icons sport_user-run mr-1"></i>
                                        Treninzi
                                    </DropdownItem>
                                    <DropdownItem to="/massage-pageSr" tag={Link}>
                                        <i className="now-ui-icons loader_refresh mr-1"></i>
                                        Masaze
                                    </DropdownItem>
                                    <DropdownItem to="/nutritionist-pageSr" tag={Link}>
                            ...
                            <NavItem>
                                <NavLink
                                    onClick={e => { e.preventDefault(); postavi(false); }}
                                >
                                    <p>eng</p>
                                </NavLink>
                            </NavItem>
